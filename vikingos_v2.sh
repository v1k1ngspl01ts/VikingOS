...
install_incus() {
    ...
    if [[ $(curl -fsSL https://pkgs.zabbly.com/key.asc | gpg --show-keys --fingerprint | grep "4EFC 5906 96CB 15B8 7C73  A3AD 82CC 8797 C838 DCFD") ]]; then
        mkdir -p /etc/apt/keyrings/
...
echo -ne "\tIf you install firefoxtools, you need to go to /opt/vikingos/web/firefoxtools and install the extensions manually"
